...
public class ViewUtil {
     ...
     * @param baseText
     * @param highlightText
     * if the string of highlightText is a subset of the string of baseText,
     * highlight the string of highlightText.
     */
    public static void showTextHighlight(TextView tv, String baseText, String highlightText){
        ...
        Log.i("zhaot9","baseText:"+baseText+",highlightText:"+highlightText);
