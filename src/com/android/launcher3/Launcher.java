...
public class Launcher extends Activity
    ...
    enum State { NONE, WORKSPACE, APPS, APPS_SPRING_LOADED, WIDGETS, WIDGETS_SPRING_LOADED ,
        WORKSPACE_PREVIEW }    // Add by zhaopenglin for screen edit 20160910
...
//            android.os.SystemProperties.getBoolean(PROP_DISABLE_APPLIST_WHITE_BG, true);
    ...
    private void setupViews() {
        ...
        mWorkspacePreview = (RGKWorkspacePreviewScrollLayout) findViewById(R.id.wrokspce_preview);// Add by zhaopenglin for screen edit 20160910
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                ...
                if (mAppsView != null && mWidgetsView != null &&
                        ...
                        && !isPreviewStates()) {//修改在编辑界面锁屏后背景是workspace界面的bug
                    showWorkspace(false);
                }
